...
public class AlarmSettingsTask extends AsyncTask<Void, Void, Integer>{
	...
	public AlarmSettingsTask(CameraMenuActivity context, Camera camera) {
	...
	protected void onPostExecute(Integer result) {
		...
		if(result == CONNECTION_ERROR) {
            ...
            context.startAlarmSettingsActivity(cameraParams);
		}
	}
