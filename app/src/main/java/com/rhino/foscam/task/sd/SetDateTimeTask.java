...
import com.rhino.foscam.activity.sd.DateTimeSettingsActivity;
...
public class SetDateTimeTask extends AsyncTask<Void, Void, Integer>{
	...
	public SetDateTimeTask(DateTimeSettingsActivity context, Camera camera, CameraParams cameraParams) {
	...
	protected Integer doInBackground(Void... params) {
		...
		try {
			success = CameraUtilsSD.setDateTime(camera, cameraParams);
		} catch (Exception e) {
