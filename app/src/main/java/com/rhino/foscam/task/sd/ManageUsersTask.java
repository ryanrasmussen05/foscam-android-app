...
public class ManageUsersTask extends AsyncTask<Void, Void, Integer>{
	...
	public ManageUsersTask(CameraMenuActivity context, Camera camera) {
	...
	protected void onPostExecute(Integer result) {
		...
		if(result == CONNECTION_ERROR) {
            ...
            context.startManageUsersActivity(cameraParams);
		}
	}
