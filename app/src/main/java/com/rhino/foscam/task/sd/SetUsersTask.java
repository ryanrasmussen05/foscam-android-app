...
public class SetUsersTask extends AsyncTask<Void, Void, Integer>{
	
	public ConnectDialog connectDialog;
	public ManageUsersActivity context;
	...
	public SetUsersTask(ManageUsersActivity context, Camera camera, CameraParams cameraParams) {
	...
	protected Integer doInBackground(Void... params) {
		...
		try {
			success = CameraUtilsSD.setusers(camera, cameraParams);
		} catch (Exception e) {
