...
public class PTSettingsTask extends AsyncTask<Void, Void, Integer>{
	...
	public PTSettingsTask(CameraMenuActivity context, Camera camera) {
	...
	protected Integer doInBackground(Void... params) {
		try {
			miscParams = CameraUtilsSD.getMiscParams(camera);
		} catch (Exception e) {
	...
	protected void onPostExecute(Integer result) {
		...
		if(result == CONNECTION_ERROR) {
            ...
            context.startPTSettingsActivity(miscParams);
		}
	}
